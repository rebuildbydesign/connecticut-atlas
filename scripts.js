...
var map = new mapboxgl.Map({
    ...
    center: [-72.7554, 41.6032], // CENTERED ON CONNECTICUT
    zoom: 7.4,
    minZoom: 6.4
});
...
function addCongressionalLayers() {
    map.addSource('CTCongress', {
        type: 'geojson',
        data: 'data/CT_Congress.geojson'
    });
...
function addHouseLayers() {
    map.addSource('CTHouse', {
        type: 'geojson',
        data: 'data/CT_House.geojson'
    });
...
function addSenateLayers() {
    map.addSource('CTSenate', {
        type: 'geojson',
        data: 'data/CT_Senate.geojson'
    });
    ...
    return `
      <div style="color:#222; font-family:inherit;">
        ...
        <ul style="list-style:none; padding:0; margin:0 0 0.9em 0;">
          <li style="margin-bottom: 3px;"><strong>U.S. Senate:</strong> Richard Blumenthal (D), Chris Murphy (D)</li>
